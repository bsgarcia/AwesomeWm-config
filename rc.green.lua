...
-- beautiful init
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-darker/green_theme.lua")
...
myawesomemenu = {
   ...
   { "> Edit theme", "gvim /home/random/.config/awesome/themes/powerarrow-darker/green_theme.lua" },
